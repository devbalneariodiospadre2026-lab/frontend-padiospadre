...
const attractions = [
  {
    ...
    image: "/attractions/INFANTIL-1.png",
    icon: Droplet,
    badge: "Relax",
  ...
  },
  {
    ...
    image: "/attractions/INFANTIL-2.png",
    icon: Zap,
    badge: "Adrenalina",
  ...
  {
    title: "Ojo De Agua",
    description: "Sin duda, uno de los principales atractivos del balneario es su emblemático “Ojo de Agua”, del cual brota un impresionante caudal de 100 litros por segundo. En esta zona podrás encontrar tres pozas, ideales para disfrutar y relajarte en sus cálidas y reconfortantes aguas termales.",
    image: "/attractions/OJO-DE-AGUA.png",
    icon: Baby,
    badge: "Familiar",
  ...
  },
  {
    ...
    image: "/attractions/OLIMPICA.png",
    icon: Trophy,
    badge: "Diversion",
    badgeColor: "bg-[#62B5E5] text-[#ffffff]",
    temperatura: "28°C",
  ...
  },
  {
    ...
    image: "/attractions/PLAYA-SIRENA.png",
    icon: Waves,
    badge: "Aventura",
    badgeColor: "bg-[#ED8B00] text-[#ffffff]",
    temperatura: "27°C",
...
export function Attractions() {
  ...
  return (
    <section id="atracciones" className="py-16 sm:py-24 bg-[#f5f7f9]">
      ...
      {/* Modal con Framer Motion - Completamente Responsivo */}
      <AnimatePresence>
        {selectedAttraction && (
          <>
            {/* Overlay */}
            ...
            <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center p-0 sm:p-4">
              ...
              >
                ...
                <motion.button
                  ...
                  onClick={() => setSelectedAttraction(null)}
                  className="absolute top-3 sm:top-4 right-3 sm:right-4 z-10 flex h-9 w-9 sm:h-10 sm:w-10 items-center justify-center rounded-full bg-[#ffffff]/90 shadow-lg hover:bg-[#ffffff] transition-colors"
                  aria-label="Cerrar"
                >
                ...
                <div className="overflow-y-auto max-h-[calc(95vh-20px)] sm:max-h-[90vh]">
                  ...
                  >
                    ...
                    {/* Icono decorativo - oculto en movil pequeno */}
                    <motion.div
